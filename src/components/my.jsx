...
export default function My({fun,fun2,data,person}){
    ...
    return(
        <div ref={scrollRef} className="   w-screen overflow-hidden relative flex ">
            <div ref={heightRightRef}  className=" flex  w-screen   relative   mb-4   justify-center items-center flex-col gap-2">
                <p className=" font-extrabold text-violet-700 p-2 text-2xl mb-3 text-center">name</p>
            {data.map((item)=>{
                return(
                    <div onClick={()=>{
                        scrollLeft(item['id'])
            ...
            <div ref={heightRef} className=" absolute -right-full  w-screen flex flex-col gap-2">
            ...
            <div className="seeper border h-5 md:h-8 border-slate-400 p-1 rounded-sm  text-center ">name</div>
            <div className="seeper border h-5  md:h-8 border-slate-400 p-1 rounded-sm  text-center ">hazira</div>
            <div className="seeper border h-5  md:h-8 border-slate-400 p-1 rounded-sm text-center ">rate</div>
            <div className="seeper border h-5  md:h-8 border-slate-400 p-1 rounded-sm  text-center ">mot</div>
            <div className="seeper border h-5  md:h-8 border-slate-400 p-1 rounded-sm text-center ">khoraki</div>
            <div className="seeper border h-5  md:h-8  border-slate-400 p-1 rounded-sm text-center ">barti</div>
            <div className="seeper border h-5  md:h-8 border-slate-400 p-1 rounded-sm text-center ">gotomas</div>
            <div className="seeper border h-5  md:h-8 border-slate-400 p-1 rounded-sm text-center ">paona</div>
